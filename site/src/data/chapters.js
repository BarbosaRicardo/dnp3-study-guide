export const CHAPTERS = [
  ...
  { id: 'intro',       label: 'Ch 1: DNP3 Overview',         emoji: '📡', path: '/intro' },
  { id: 'layers',      label: 'Ch 2: Protocol Layers',       emoji: '🧱', path: '/layers' },
  { id: 'datalink',    label: 'Ch 3: Data Link Layer',       emoji: '🔗', path: '/datalink' },
  { id: 'appLayer',    label: 'Ch 4: Application Layer',     emoji: '📦', path: '/appLayer' },
  { id: 'objects',     label: 'Ch 5: Data Objects & Groups', emoji: '🗂️', path: '/objects' },
  { id: 'fc',          label: 'Ch 6: Function Codes',        emoji: '⚙️', path: '/fc' },
  { id: 'unsol',       label: 'Ch 7: Unsolicited Responses', emoji: '📣', path: '/unsol' },
  { id: 'security',    label: 'Ch 8: Secure Authentication', emoji: '🔒', path: '/security' },
  { id: 'troubleshoot',label: 'Ch 9: Troubleshooting',       emoji: '🔍', path: '/troubleshoot' },
  { id: 'lab',         label: 'Ch 10: Lab & Practice',       emoji: '🧪', path: '/lab' },
]

export const FUN_FACTS = [
  { text: "DNP3 was designed in the early 1990s by Westronic Inc. for electric utilities in North America. It was based on IEC 60870-5, a European standard, because apparently even protocol designers steal good ideas from Europe.", emoji: "🌍" },
  { text: "The 'D' in DNP3 stands for 'Distributed.' DNP3's full name is Distributed Network Protocol. The '3' is because versions 1 and 2 were internal drafts that never shipped publicly. Classic engineers: ship version 3 first, document versions 1 and 2 never.", emoji: "🔢" },
  { text: "DNP3's CRC is CRC-16/DNP — a specific polynomial variant that is DIFFERENT from CRC-16/Modbus. If you accidentally use the Modbus CRC implementation for DNP3, every single frame will be rejected. The devices will say nothing. You will lose your mind.", emoji: "😵" },
  { text: "DNP3 start bytes are always 0x05 0x64. There is no other valid start sequence. If you're sniffing traffic and see these two bytes, you found a DNP3 frame. It's like the protocol shouts 'HERE I AM' in hex at the start of every message.", emoji: "📢" },
  { text: "DNP3 supports up to 65519 outstation addresses (0 to 0xFFF9). Modbus tops out at 247 slaves. DNP3 was built for large utility networks where a single master might poll hundreds of RTUs stretched across a state. No wonder it needs 16-bit addressing.", emoji: "🗺️" },
  { text: "An engineer at a water utility once spent two days debugging DNP3 comms before discovering the master had Secure Authentication v2 enabled and the RTU only supported SA v5. They're not backward compatible. The devices were speaking two different security dialects and silently failing. Two. Days.", emoji: "💧" },
  { text: "DNP3 Class 0 is the 'static' snapshot — current values, no timestamps. Classes 1, 2, and 3 are event buffers sorted by priority. If your Class 1 buffer fills up and you don't poll fast enough, the oldest events are dropped. Your substation just quietly forgot that breaker tripped.", emoji: "🗑️" },
  { text: "DNP3 has a built-in 'confirm' mechanism where the master must ACK unsolicited messages. If it doesn't ACK, the outstation retries. Forever. Misconfigure your unsolicited response settings and you'll get a device that spams the link every 5 seconds until the end of time.", emoji: "♾️" },
  { text: "Wireshark has had a DNP3 dissector since version 1.4. This means you can capture raw bytes, load them in Wireshark, and watch it decode every Group, Variation, Function Code, and CRC in real time. This is how you find out your vendor's 'firmware update' silently changed the object map.", emoji: "🦈" },
  { text: "The Triangle MicroWorks DNP3 test harness is the industry gold standard for interoperability testing. If your outstation doesn't work with TMW, it doesn't work. Period. Every serious DNP3 implementation gets tested against it. Budget accordingly.", emoji: "📐" },
  { text: "DNP3 timestamps are 48-bit millisecond UTC values. A 48-bit counter can represent dates until the year 10889. Whoever designed DNP3 was not going to be caught in a Y2K situation again. Reasonable, honestly.", emoji: "⏱️" },
  { text: "IEC 61968/61970 (CIM) and DNP3 overlap in utility SCADA. Some utilities run both: DNP3 for field device comms, CIM for EMS/SCADA data models. If your job posting says 'DNP3 AND CIM experience,' double your asking salary.", emoji: "💰" },
]
