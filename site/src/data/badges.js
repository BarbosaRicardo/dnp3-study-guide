export const GUIDE_KEY = 'dnp3'

const CHAPTERS = [
  'intro', 'layers', 'datalink', 'appLayer', 'objects',
  'fc', 'unsol', 'security', 'troubleshoot', 'lab',
]
...
export const BADGE_DEFS = [
  {
    ...
    hint: 'Pass Level 1 in any chapter to unlock.',
  ...
  },
  {
    ...
    hint: 'Pass Level 1 in all chapters to unlock.',
  ...
  },
  {
    ...
    hint: 'Pass Level 2 in all chapters to unlock.',
  ...
  },
  {
    ...
    hint: 'Pass Level 3 in any chapter to unlock.',
  ...
  },
  {
    ...
    hint: 'Complete Field Scenarios in any chapter to unlock.',
  ...
  },
  {
    ...
    hint: 'Pass all three levels in every chapter to unlock.',
    flavor: 'Unsolicited responses don\'t surprise you anymore.',
    color: '#fbbf24',
