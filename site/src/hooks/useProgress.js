...
const STORAGE_KEY = 'dnp3_progress_v1'
const PROGRESS_EVENT = 'dnp3_progress_update'
...
export function useProgress() {
  ...
  const overallProgress = () => {
    const chapters = ['intro', 'layers', 'datalink', 'appLayer', 'objects', 'fc', 'unsol', 'security', 'troubleshoot', 'lab']
